export default function NegativeTestPanel({ negativeTest }) {
  ...
  return (
    <section className="relative mt-8 overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 p-6 sm:p-8">
      ...
      <div className="relative">
        ...
        <p className="mt-2 max-w-xl text-sm leading-6 text-slate-400">
          This vulnerability scored higher on raw severity (CVSS {negativeTest.cvss_base_score})
          than every item in your top 5 — and still didn't make the list. The specific reason is
          below, not a generic severity cutoff.
        </p>
